...
class StreamIOWrapper(io.IOBase):
    __doc__ = 'Wraps file-like objects that are not inheriting from IOBase'
...
class StreamIOIterWrapper(io.IOBase):
    __doc__ = 'Wraps a iterator and turn it into a file-like object'
...
class StreamIOThreadWrapper(io.IOBase):
    __doc__ = """Wraps a file-like object in a thread.
