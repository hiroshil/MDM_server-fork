...
class Chunk(BytesIO):
    __doc__ = 'A single chunk, part of the buffer.'
...
class Buffer(object):
    __doc__ = """Simple buffer for use in single-threaded consumer/filler.
...
class RingBuffer(Buffer):
    __doc__ = 'Circular buffer for use in multi-threaded consumer/filler.'
