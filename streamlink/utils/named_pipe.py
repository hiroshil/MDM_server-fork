...
class NamedPipe(object):
    ...
    def __init__(self, name, buffer_size=16384):
        self.fifo = None
        self.pipe = None
    ...
    def _create_named_pipe(self, path):
        ...
        pipe = create_named_pipe(path, PIPE_ACCESS_OUTBOUND, PIPE_TYPE_BYTE | PIPE_READMODE_BYTE | PIPE_WAIT, PIPE_UNLIMITED_INSTANCES, self.bufsize, self.bufsize, 0, None)
